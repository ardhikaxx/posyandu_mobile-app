...
class AuthController {
  ...
  static Future<void> login(
    ...
    try {
      const String apiUrl = "http://10.10.181.218:8000/api/auth/login";
  ...
  static Future<void> tokenRequest(BuildContext context, String token) async {
    try {
      final responseData = await http.get(
        Uri.parse("http://10.10.181.218:8000/api/auth/me"),
  ...
  static Future<void> logout(BuildContext context, String token) async {
    try {
      const String apiUrl = "http://10.10.181.218:8000/api/auth/logout";
  ...
  static Future<void> register(
    ...
    try {
      const String apiUrl = "http://10.10.181.218:8000/api/auth/register";
  ...
  static Future<bool> checkEmail(BuildContext context, String email) async {
    try {
      const String apiUrl = "http://10.10.181.218:8000/api/auth/check-email";
  ...
  static Future<void> changePassword(
    ...
    try {
      const String apiUrl =
          "http://10.10.181.218:8000/api/auth/change-password";
      final response = await http.post(
        Uri.parse(apiUrl),
        body: {
          'email_orang_tua': email,
